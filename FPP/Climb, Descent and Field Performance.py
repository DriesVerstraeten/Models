...
V_Y = sqrt((2/rho)*(W_TO/S)*sqrt((1./(pi*A*e))/(3*CD_0)))

#Rate of climb
ROC_max = 60*(((etha_p*550*P_TO)/W_TO)-(V_Y*(1.1547/LD_max)))
ROC_max_si = ROC_max*0.00508

print
print "Maximum rate of climb =", ROC_max_si,"m/s"
