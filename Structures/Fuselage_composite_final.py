...
def thickness(r,M_x,M_y,S_x,S_y,T,sigma_t,sigma_c,tau,t_c_min,dp,sigma_hoop,rho_f,rho_c,E_x,E_c):
    ...
    h_c = t_eq-2*t_f
    h_c = t_c_min
    t_f = (t_eq*rho_f-h_c*rho_c)/(2*rho_f)
    return t_f, h_c

def mass(r,M_x,M_y,S_x,S_y,T,sigma_t,tau,t_c_min,sigma_c,dp,sigma_hoop,rho_f,rho_c,E_x,E_c):
        dm = (2*thickness(r,M_x,M_y,S_x,S_y,T,sigma_t,sigma_c,tau,t_c_min,dp,sigma_hoop,rho_f,rho_c,E_x,E_c)[0] \
         *rho_f+thickness(r,M_x,M_y,S_x,S_y,T,sigma_t,sigma_c,tau,t_c_min,dp,sigma_hoop,rho_f,rho_c,E_x,E_c)[1]*\
