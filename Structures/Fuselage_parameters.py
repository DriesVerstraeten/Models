...
x_front   = np.linspace(L_i,L_ii_front+L_i,3)
x_const   = np.linspace(L_ii_front+L_i,L_ii_front+L_i+L_ii_const,2)
x_back    = np.linspace(L_ii_front+L_i+L_ii_const,L_ii_front+L_i+ \
                        L_ii_const+L_ii_back,3)
